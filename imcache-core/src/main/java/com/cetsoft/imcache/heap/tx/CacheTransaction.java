...
public class CacheTransaction implements Transaction {
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.cache.heap.tx.Transaction#begin()
     */
    public void begin() {
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.cache.heap.tx.Transaction#commit()
     */
    public void commit() {
        if (this.transactionStatus == TransactionStatus.ACTIVE) {
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.cache.heap.tx.Transaction#rollback()
     */
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.cache.heap.tx.Transaction#close()
     */
    public void close() {
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.cache.heap.tx.Transaction#getStatus()
     */

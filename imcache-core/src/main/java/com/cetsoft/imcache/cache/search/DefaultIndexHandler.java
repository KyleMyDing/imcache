...
import com.KyleDing.imcache.cache.search.criteria.AndCriteria;
import com.KyleDing.imcache.cache.search.criteria.ArithmeticCriteria;
import com.KyleDing.imcache.cache.search.criteria.Criteria;
import com.KyleDing.imcache.cache.search.criteria.DiffCriteria;
import com.KyleDing.imcache.cache.search.criteria.OrCriteria;
import com.KyleDing.imcache.cache.search.index.CacheIndex;
import com.KyleDing.imcache.cache.search.index.IndexNotFoundException;
import com.KyleDing.imcache.cache.search.index.IndexType;
import com.KyleDing.imcache.cache.search.index.NonUniqueHashIndex;
import com.KyleDing.imcache.cache.search.index.RangeIndex;
...
public class DefaultIndexHandler<K, V> implements IndexHandler<K, V> {
     ...
     *
     * @see
     * com.KyleDing.imcache.cache.search.Indexable#addIndex(com.KyleDing.imcache
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.cache.search.IndexHandler#add(java.lang.Object,
     * java.lang.Object)
     */
     ...
     *
     * @see
     * com.KyleDing.imcache.cache.search.IndexHandler#remove(java.lang.Object,
     * java.lang.Object)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.cache.search.IndexHandler#clear()
     */
    public void clear() {
        indexes.clear();
    }
     ...
     *
     * @see
     * com.KyleDing.imcache.cache.search.IndexHandler#execute(com.KyleDing.imcache
     * .cache.search.Query)
     */

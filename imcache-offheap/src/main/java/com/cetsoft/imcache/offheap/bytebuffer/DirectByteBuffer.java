...
public class DirectByteBuffer implements ByteBuffer {
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.bytebuffer.ByteBuffer#get(int, byte[], int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.bytebuffer.ByteBuffer#put(int, byte[], int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.bytebuffer.ByteBuffer#free()
     */
    public void free() {
        try {

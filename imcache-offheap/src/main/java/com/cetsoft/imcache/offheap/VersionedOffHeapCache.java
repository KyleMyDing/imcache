...
public class VersionedOffHeapCache<K, V> implements SearchableCache<K, VersionedItem<V>> {
     ...
     *
     * @see
     * com.KyleDing.imcache.cache.SearchableCache#execute(com.KyleDing.imcache
     * .cache.search.Query)
     */
    ...
    protected static class CacheItemCacheLoader<K, V> implements CacheLoader<K, VersionedItem<V>> {
         ...
         * (non-Javadoc)
         *
         * @see com.KyleDing.imcache.cache.CacheLoader#load(java.lang.Object)
         */
    ...
    protected static class CacheItemSerializer<V> implements Serializer<VersionedItem<V>> {
         ...
         *
         * @see
         * com.KyleDing.imcache.serialization.Serializer#serialize(java.lang.
         * Object)
         */
    ...
    protected static class CacheItemIndexHandler<K, V> implements IndexHandler<K, VersionedItem<V>> {
         ...
         *
         * @see
         * com.KyleDing.imcache.cache.search.IndexHandler#add(java.lang.Object,
         * java.lang.Object)
         */
         ...
         *
         * @see
         * com.KyleDing.imcache.cache.search.IndexHandler#execute(com.KyleDing

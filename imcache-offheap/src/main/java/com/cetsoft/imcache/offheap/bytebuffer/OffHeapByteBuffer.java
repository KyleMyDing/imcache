...
public class OffHeapByteBuffer implements OffHeapStore {
     ...
     *
     * @see
     * com.KyleDing.imcache.bytebuffer.OffHeapStore#retrieve(com.KyleDing.imcache
     * .bytebuffer.Pointer)
     */
     ...
     *
     * @see
     * com.KyleDing.imcache.bytebuffer.OffHeapStore#remove(com.KyleDing.imcache
     * .bytebuffer.Pointer)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.bytebuffer.OffHeapStore#store(byte[])
     */
     ...
     *
     * @see
     * com.KyleDing.imcache.bytebuffer.OffHeapStore#update(com.KyleDing.imcache
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.bytebuffer.OffHeapStore#dirtyMemory()
     */
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.bytebuffer.OffHeapStore#usedMemory()
     */
     ...
     * (non-Javadoc)
     *
     * @see com.KyleDing.imcache.bytebuffer.OffHeapStore#freeMemory()
     */
